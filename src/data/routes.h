...
public:
    ...
    virtual QString getPairPriceChange(QString exchange_symbol, QString pair) = 0;
    virtual QString getPairHighestPrice(QString exchange_symbol, QString pair) = 0;
    virtual QString getPairLowestPrice(QString exchange_symbol, QString pair) = 0;
};
#endif